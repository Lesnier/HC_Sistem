var app=angular.module("AltasBajasDigitador",[]);
	app.controller("Digitador",["$scope","$http",function($scope,$http){   
		$scope.Buscar;
		$scope.DataSecRece=[];
		$scope.SecRecep=[];
		$scope.Cedula;
		...
		$scope.BuscarSecreRe=function() {
			$http.get('../Procesar.php?accion=DataDigitador&Buscar='+$scope.Buscar)
