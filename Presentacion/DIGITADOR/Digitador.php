<!DOCTYPE html>
<html ng-app="AltasBajasDigitador">
<head>
	<title></title>
	<script type="text/javascript" src="../js/angular.js"></script>
	<script type="text/javascript" src="js/ControlerDigit.js"></script>
							...
							<td>
								<center>
									<div class="input-append">
											...
											<a class="btn"><i class="icon-search"></i> Buscar Digitador</a>
									</div>
								</center>
							</td>
						</tr>
