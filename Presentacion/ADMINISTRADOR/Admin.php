<!DOCTYPE html>
<html ng-app="AltasBajasAdm">
<head>
	<title></title>
	<script type="text/javascript" src="../js/angular.js"></script>
	<script type="text/javascript" src="js/ControlerAdmin.js"></script>
	...
	<div class="container-fluid">
		<div class="row-fluid">
				<div class="span12">
							...
							<td>
								<center>
									<div class="input-append">
											<input type="text" ng-model="Buscar" ng-keypress="BuscarAdm()" >
											<a class="btn"><i class="icon-search"></i> Buscar Administrador</a>
									</div>
								</center>
							</td>
						</tr>
					...
					<table ng-show="DataAdmin.length>0" class="table table-bordered table-striped table-condensend">
						<tr>
							<th>Cedula</th>
							<th>Usuario</th>
							<th></th>
						...
						<tr ng-repeat="user in DataAdmin">
							<td>{{user.Cedula}}</td>
							<td>{{user.Usuario}}</td>
					...
					<table ng-show="Codigo>0" class="table table-bordered table-striped table-condensend">
						...
						<tr>
							<td colspan="4">
								<center>
									<a href="" class="btn" ng-click="SaveAdmin()" > Guardar</a>
