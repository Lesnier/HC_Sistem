...
$IdAnamHosp = '';
	...
	if (isset($_GET["Codigo"]) && isset($_GET["IdAnamHosp"])  ) 
	{
		$codigo = $_GET["Codigo"];
		$IdAnamHosp = $_GET["IdAnamHosp"];
...
$html = "";
					...
					$datos=$aux->Consultar_AnamnesisHosp("SELECT * FROM tbl_anamnesis_hosp WHERE id_anam_hosp='$IdAnamHosp' AND id_pac=$codigo");
