...
function FancyTable()
{
	...
	$fecha=$expe->Consultar("SELECT fechasa_cduanm FROM tbl_cduanamnesis WHERE id_cduanam='$id';");
	...
	$this->SetXY(3.7,5.2);
	$this->SetFont('Arial','b',8);
	$this->Cell(0.8,0.6,utf8_decode(""),0,1,'C',false);
	...
	$this->SetXY(4.6,5.3);
	$this->SetFont('Arial','b',8);
	$this->MultiCell(6.4,0.4,utf8_decode(""),0,1,'L',false);
	
	//prescripciones
	$pres1=$expe->Consultar("SELECT CONCAT(cie1_cduanam,' ',codcie1_cduanam) FROM tbl_cduanamnesis WHERE id_cduanam='$id';");
	$pres2=$expe->Consultar("SELECT CONCAT(cie2_cduanam,' ',codcie2_cduanam) FROM tbl_cduanamnesis WHERE id_cduanam='$id';");
	$pres3=$expe->Consultar("SELECT CONCAT(cie3_cduanam,' ',codcie3_cduanam) FROM tbl_cduanamnesis WHERE id_cduanam='$id';");
	$pres4=$expe->Consultar("SELECT CONCAT(cie4_cduanam,' ',codcie4_cduanam) FROM tbl_cduanamnesis WHERE id_cduanam='$id';");
	$pres5=$expe->Consultar("SELECT CONCAT(cie5_cduanam,' ',codcie5_cduanam) FROM tbl_cduanamnesis WHERE id_cduanam='$id';");
	$pres6=$expe->Consultar("SELECT planesdte_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$id';");
	...
	$this->SetXY(11.2,5.3);
	$this->SetFont('Arial','b',8);
	$this->MultiCell(6.4,0.4,utf8_decode("$pres1\n$pres2\n$pres3\n$pres4\n$pres5\n$pres6   "),0,1,'L',false);
	...
	$this->SetXY(17.7,5.3);
	$this->SetFont('Arial','b',8);
	$this->Cell(1.8,0.4,utf8_decode(""),0,1,'L',false);
