...
function FancyTable()
{
	...
	$datos=$tur->Consultar_Turno("SELECT * FROM tbl_turno WHERE id_usu='$code' AND fechaC_tu='$fi' ORDER BY  id_hor ASC ");
	//$id=$_GET['id'];
	...
	$this->Cell(7.5,1,utf8_decode('Citas del medico '),0,1,'L',false);
