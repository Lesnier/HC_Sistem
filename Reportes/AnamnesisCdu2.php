...
function FancyTable()
{
	...
	$code=$_GET['code'];
	$idPac=$anam->Consultar("SELECT id_pac FROM tbl_cduanamnesis WHERE id_cduanam='$code';");
	//$id=$_GET['id'];
	...
	$this->SetXY(5.9,4.3);
	$this->SetFont('Arial','b',10);
	$this->Cell(9,0.6,utf8_decode('NOMBRE COMPLETOS'),1,1,'C',true);
	
	$nom=$anam->Consultar("SELECT nombresCom_pac FROM tbl_paciente WHERE id_pac='$idPac'");
	
	$this->SetXY(5.9,4.9);
	$this->SetFont('Arial','b',8);
	$this->Cell(9,0.6,utf8_decode("$nom"),1,1,'C',false);
	...
	$cons=$anam->Consultar("SELECT motivoc_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$antepe=$anam->Consultar("SELECT anteper_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$antefa=$anam->Consultar("SELECT antefam_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$enfac=$anam->Consultar("SELECT enferac_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$revoys=$anam->Consultar("SELECT reviorgsis_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	//f1
	$fech1=$anam->Consultar("SELECT fecha1_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(5.7,17.1);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$fech1"),1,1,'C',true);
	//f2
	$fech2=$anam->Consultar("SELECT fecha2_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(9.2,17.1);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$fech2"),1,1,'C',true);
	//f3
	$fech3=$anam->Consultar("SELECT fecha3_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(12.7,17.1);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$fech3"),1,1,'C',true);
	//f4
	$fech4=$anam->Consultar("SELECT fehca4_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	...
	//p1
	$prear1=$anam->Consultar("SELECT prearte1_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(5.7,17.7);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$prear1"),1,1,'C',true);
	//p2
	$prear2=$anam->Consultar("SELECT prearte2_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(9.2,17.7);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$prear2"),1,1,'C',true);
	//p3
	$prear3=$anam->Consultar("SELECT prearte3_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(12.7,17.7);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$prear3"),1,1,'C',true);
	//p4
	$prear4=$anam->Consultar("SELECT prearte4_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	...
	//pxm1
	$pulsoxm1=$anam->Consultar("SELECT pulso1_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(5.7,18.3);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$pulsoxm1"),1,1,'C',true);
	//pxm2
	$pulsoxm2=$anam->Consultar("SELECT pulso2_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(9.2,18.3);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$pulsoxm2"),1,1,'C',true);
	//pxm3
	$pulsoxm3=$anam->Consultar("SELECT pulso3_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(12.7,18.3);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$pulsoxm3"),1,1,'C',true);
	//pxm4
	$pulsoxm4=$anam->Consultar("SELECT pulso4_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	...
	//t1
	$temp1=$anam->Consultar("SELECT temp1_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(5.7,18.9);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$temp1"),1,1,'C',true);
	//t2
	$temp2=$anam->Consultar("SELECT temp2_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(9.2,18.9);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$temp2"),1,1,'C',true);
	//t3
	$temp3=$anam->Consultar("SELECT temp3_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	$this->SetXY(12.7,18.9);
	$this->SetFont('Arial','b',9);
	$this->Cell(3.5,0.6,utf8_decode("$temp3"),1,1,'C',true);
	//t4
	$temp4=$anam->Consultar("SELECT temp4_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	$this->SetFillColor(300, 300, 300);
	...
	$exfi=$anam->Consultar("SELECT examfi_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cie1=$anam->Consultar("SELECT cie1_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cod1=$anam->Consultar("SELECT codcie1_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	
	$this->SetXY(16.3,4.1);
	$this->SetFont('Arial','b',8);
	$this->MultiCell(1.9,0.6,utf8_decode("$cod1"),1,1,'L',false);
	//pre1
	$idanam=$anam->Consultar("SELECT MAX(id_cduanam) FROM tbl_cduanamnesis WHERE id_cduanam='$code' ");
	...
	$cie2=$anam->Consultar("SELECT cie2_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cod2=$anam->Consultar("SELECT codcie2_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cie3=$anam->Consultar("SELECT cie3_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cod3=$anam->Consultar("SELECT codcie3_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cie4=$anam->Consultar("SELECT cie4_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cod4=$anam->Consultar("SELECT codcie4_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cie5=$anam->Consultar("SELECT cie5_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$cod5=$anam->Consultar("SELECT codcie5_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$planes=$anam->Consultar("SELECT planesdte_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$fecontr=$anam->Consultar("SELECT fechcontr_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$horafin=$anam->Consultar("SELECT horafin_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$med=$anam->Consultar("SELECT medico_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
	...
	$codm=$anam->Consultar("SELECT codmed_cduanam FROM tbl_cduanamnesis WHERE id_cduanam='$code' ORDER BY id_cduanam DESC");
