...
class PDF extends FPDF
{
 function Mifecha()
	...
	function Cuerpo()
	{
		...
		$apellido=$ep->Consultar("SELECT apellidos_pac FROM tbl_paciente WHERE id_pac='$codpac';");
	    ...
	    $this->SetXY(2,5.5);
	    $this->SetFont('Arial','b',8);
	    $this->Cell(7,0.5,utf8_decode('APELLIDOS'),1,1,'L',true);

	    $this->SetXY(2,6);
	    $this->SetFont('Arial','b',6);
	    $this->Cell(7,0.5,utf8_decode("$apellido"),1,1,'L',false);
